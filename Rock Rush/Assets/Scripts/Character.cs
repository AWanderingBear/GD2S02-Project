...
public class Character : MonoBehaviour 
{
    ...
    public virtual void UpdatePhysics()
	{
        ...
        //if (Physics2D.Raycast(new Vector2(_transform.position.x - 0.1f,_transform.position.y), -Vector2.up, 0.26f, groundMask) 
        //    || Physics2D.Raycast(new Vector2(_transform.position.x + 0.1f,_transform.position.y), -Vector2.up, 0.26f, groundMask))
